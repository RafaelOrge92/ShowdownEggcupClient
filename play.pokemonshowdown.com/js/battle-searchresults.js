...
updateHover=function updateHover(){var _this$base2,_list$querySelector,_list$querySelector2;
var list=((_this$base2=this.base)==null?void 0:_this$base2.querySelector('.dexlist'))||null;
if(!list)return;
(_list$querySelector=list.querySelector('.hover'))==null||_list$querySelector.classList.remove('hover');
(_list$querySelector2=list.querySelector("li.result[value=\""+this.props.search.resultIndex+"\"] > a"))==null||_list$querySelector2.classList.add('hover');
};_proto.
...
updateDOM=function updateDOM(){var _this$base3,_this$base4,_this$base5;var force=arguments.length>0&&arguments[0]!==undefined?arguments[0]:true;
var list=((_this$base3=this.base)==null?void 0:_this$base3.querySelector('.dexlist'))||null;
if(!list)return;
var search=this.props.search;
var results=search.results||[];
var scrollTop=((_this$base4=this.base)==null?void 0:_this$base4.scrollTop)||0;
var viewHeight=((_this$base5=this.base)==null?void 0:_this$base5.clientHeight)||window.innerHeight;
...
var topSpacer=start*RESULT_ROW_HEIGHT;
var bottomSpacer=(results.length-end)*RESULT_ROW_HEIGHT;
...
componentDidMount=function componentDidMount(){var _this$base6;
(_this$base6=this.base)==null||_this$base6.addEventListener('scroll',this.handleScroll);
this.props.search.resultsComponent=this;
this.updateDOM(true);
};_proto.

componentWillUnmount=function componentWillUnmount(){var _this$base7;
(_this$base7=this.base)==null||_this$base7.removeEventListener('scroll',this.handleScroll);
