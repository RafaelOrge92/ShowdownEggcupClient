...
_this2.setState({search:e.currentTarget.value});
};_this2.
...
var someOpen=false;
var allOpen=true;for(var _i2=0,_this2$getDetailsElem2=
_this2.getDetailsElements();_i2<_this2$getDetailsElem2.length;_i2++){var detail=_this2$getDetailsElem2[_i2];
if(detail.open){
someOpen=true;
}else{
allOpen=false;
...
var collapseAll=_this2.base.querySelector('input[name=collapseall]');
...
var checked=e.currentTarget.checked;for(var _i4=0,_this2$getDetailsElem4=
_this2.getDetailsElements();_i4<_this2$getDetailsElem4.length;_i4++){var detail=_this2$getDetailsElem4[_i4];
detail.open=!checked;
}
};return _this2;}_inheritsLoose(ResourcePanel,_PSRoomPanel);var _proto2=ResourcePanel.prototype;_proto2.receiveLine=function receiveLine(){};_proto2.getDetailsElements=function getDetailsElements(){return this.base.querySelectorAll('details.commandlist');};_proto2.
...
getCommandList=function getCommandList(){var _this3=this;
if(typeof BattleChatCommands!=='object'){
document.addEventListener('ready',function(){return _this3.setState({commandsLoaded:true});});
